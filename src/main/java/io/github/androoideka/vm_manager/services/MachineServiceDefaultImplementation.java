...
import io.github.androoideka.vm_manager.controllers.MessageController;
...
import io.github.androoideka.vm_manager.mappers.MachineMapper;
import io.github.androoideka.vm_manager.model.*;
...
public class MachineServiceDefaultImplementation implements MachineService {
    ...
    @Autowired
    public MachineServiceDefaultImplementation(MachineMapper machineMapper, MachineRepository machineRepository,
            UserService userService, ErrorLogService errorLogService, TaskScheduler taskScheduler,
    ...
    @Override
    public Page<MachineResponse> search(String name, List<String> statuses, LocalDate dateFrom, LocalDate dateTo,
    ...
    private boolean isReadyToExecute(Machine machine, MachineOperation machineOperation) {
        ...
        // Updating the opCounter on the object manually because getting it from the
        // database doesn't work due to some JPA cache and I don't want to purge it
